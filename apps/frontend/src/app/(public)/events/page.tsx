      ...
      <section className="container mx-auto px-4 md:px-8 text-center space-y-4">
        ...
        <HeroEntrance delay={0.3}>
          <p className="text-slate-400 max-w-xl mx-auto text-base">
            Join our flagship technical workshops, hands-on bootcamps, and competitive hackathons.
          </p>
        </HeroEntrance>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {filteredEvents.map((event, index) => (
              <ScrollReveal key={event._id} direction="up" delay={index * 0.1}>
                <GlassCard className="flex flex-col h-full space-y-4 overflow-hidden group">
